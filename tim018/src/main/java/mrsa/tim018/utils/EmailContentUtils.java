...
public class EmailContentUtils {
	...
	public static String getVerificationContent() {
		...
		String body = "                              To complete your profile and start enjoying vacations with Hakuna Matata, you'll need to verify your email address.\r\n";
	...
	public static String getRegistrationResponseContent(RequestStatus status, String adminExpl) {
		String firstLine, mainText, explanation, finish, btnText;
		if (status == RequestStatus.Accepted) {
			firstLine = "                              YOU'RE ONE STEP AWAY\r\n";
			mainText = "                              Your account has been accepted\r\n";
			explanation = "";
			finish = "                              Login to your account and start posting your offers on Hakuna Matata.\r\n";
			btnText = "                                                LOGIN\r\n";
		} else {
			firstLine = "                              WE ARE SORRY TO INFORM YOU\r\n";
			mainText = "                              Your account has not been accepted\r\n";
			explanation = "							" + adminExpl + "\r\n"; 
			finish = "                              Try again to register and provide all necessary inforamation about your offers.\r\n";
			btnText = "                                                REGISTER\r\n";
		}
	...
	public static String getDeleteProfileResponseContent(RequestStatus status, String adminExpl) {
		String firstLine, mainText, explanation;
		if (status == RequestStatus.Accepted) {
			firstLine = "                              HAKUNA MATATA WANTS TO INFORM YOU THAT\r\n";
			mainText = "                              Your request for deletion of your account has been accepted\r\n";
			explanation = "							" + adminExpl + "\r\n"; 
		} else {
			firstLine = "                              WE ARE SORRY TO INFORM YOU\r\n";
			mainText = "                              Your request for deletion of your account has not been accepted\r\n";
			explanation = "							" + adminExpl + "\r\n"; 
		}
	...
	public static String getClientsComplaintResponseToClient(String mailClient, Client client) {
		String title = "                              Your complaint has been sent to user\r\n";
		String body = mailClient;
		String buttonText = "";
		return originalTemplate(title, body, buttonText);
	}

	public static String getClientsComplaintResponseToRenter(String mailClient, Client client) {
