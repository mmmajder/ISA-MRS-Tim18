    ...
    switch (userType) {
        case "FishingInstructor":
            retData=(<NavDropdown title={<span><FontAwesomeIcon icon={faFishFins} />Adventures </span>}> 
                <NavDropdown.Item href="/welcome/resorts"><FontAwesomeIcon icon={faFishFins} /> My adventures</NavDropdown.Item> 
                <NavDropdown.Item href="/welcome/createResort"><FontAwesomeIcon icon={faPlus} /> Add new adventures</NavDropdown.Item>
        ...
        case "ResortRenter":
            retData=(<NavDropdown title={<span><FontAwesomeIcon icon={faHouseChimney} />Resorts </span>}> 
                <NavDropdown.Item href="/welcome/resorts"><FontAwesomeIcon icon={faHouseChimney} /> My resorts</NavDropdown.Item> 
                <NavDropdown.Item href="/welcome/createResort"><FontAwesomeIcon icon={faPlus} /> Add new resorts</NavDropdown.Item>
        ...
        case "BoatRenter":
            retData=(<NavDropdown title={<span><FontAwesomeIcon icon={faAnchor} />Boats </span>}> 
                <NavDropdown.Item href="/welcome/resorts"><FontAwesomeIcon icon={faShip} /> My boats</NavDropdown.Item> 
                <NavDropdown.Item href="/welcome/createResort"><FontAwesomeIcon icon={faPlus} /> Add new boats</NavDropdown.Item>
